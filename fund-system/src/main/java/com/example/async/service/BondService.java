...
//            log.info("債券系統 - 關聯 ID 為 {} 的 SSE 連線已完成", correlationId);
//            sseEmitterMap.remove(correlationId);
//        });
//
//        emitter.onTimeout(() -> {
//            log.info("債券系統 - 關聯 ID 為 {} 的 SSE 連線超時", correlationId);
//            sseEmitterMap.remove(correlationId);
//            emitter.complete();
//        });
//
//        emitter.onError(ex -> {
//            log.error("債券系統 - 關聯 ID 為 {} 的 SSE 發生錯誤", correlationId, ex);
//            sseEmitterMap.remove(correlationId);
//            emitter.complete();
//        });
//
...
//                }
//            } catch (IOException e) {
//                log.error("債券系統 - 向關聯 ID 為 {} 的 SSE 發送事件時出錯", correlationId, e);
//                emitter.completeWithError(e);
//                sseEmitterMap.remove(correlationId);
//            }
//        } else {
//            log.warn("債券系統 - 找不到關聯 ID 為 {} 的 SSE emitter", correlationId);
//        }
//    }
//}